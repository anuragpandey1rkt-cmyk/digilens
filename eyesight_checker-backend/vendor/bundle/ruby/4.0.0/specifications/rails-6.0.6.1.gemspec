...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionview>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<activemodel>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<activerecord>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<activejob>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<actioncable>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<activestorage>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.0.6.1".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, ["= 6.0.6.1".freeze])
